...
class Ui_Widget(object):
    def setupUi(self, Widget):
        ...
        self.senhaInput = QLineEdit(self.gridFrame)
        self.senhaInput.setObjectName(u"senhaInput")
        font2 = QFont()
        font2.setFamilies([u"Open Sans"])
        font2.setPointSize(14)
        self.senhaInput.setFont(font2)
        self.senhaInput.setStyleSheet(u"border-radius: 10; background-color: rgb(245, 245, 245); height:40")
        self.senhaInput.setEchoMode(QLineEdit.Password)
        self.senhaInput.setCursorPosition(4)

        self.gridLayout.addWidget(self.senhaInput, 9, 1, 1, 1)

        self.usuarioInput = QLineEdit(self.gridFrame)
        self.usuarioInput.setObjectName(u"usuarioInput")
        self.usuarioInput.setFont(font2)
        self.usuarioInput.setStyleSheet(u"border-radius: 10; background-color: rgb(245, 245, 245); height:40")

        self.gridLayout.addWidget(self.usuarioInput, 6, 1, 1, 1)
...
"border-radius: 20;  background-color: qlineargradient(spread:pad, x1:0, y1:1, x2:1, y2:0, stop:0 rgba(237, 172, 20, 255), stop:1 rgba(255, 102, 0, 255)); color: rgb(253, 253, 253); height: 50; width:250;  position: relative;  margin-left: 50%; margin-right: 50%;\n"
"}\n"
...
"} ")
    ...
    def retranslateUi(self, Widget):
        ...
        self.senhaInput.setText(QCoreApplication.translate("Widget", u"1234", None))
        self.usuarioInput.setText(QCoreApplication.translate("Widget", u"Professor", None))
